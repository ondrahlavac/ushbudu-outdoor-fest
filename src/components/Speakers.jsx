...
import ondrejVoseckyImage from '@/images/avatars/ondrej-vosecky.jpg'
...
const days = [
  {
    ...
    speakers: [
      {
        name: 'Yannick Besancon',
        role: 'Nomad Lines - Freeskiing v Kazachstánu',
        image: yannickBesanconImage,
      },
      {
        name: 'Tom Baud',
        role: 'Nomad Lines - Freeskiing v Kazachstánu',
      ...
      },
      {
        ...
        role: 'Kanadský bajkový shredding',
        image: petrDocekalImage,
      },
      {
        name: 'Josef Little',
        role: 'O lezení a sólování',
        image: josefLittleImage,
      },
      {
        name: 'Ondřej Vosecký',
      ...
      <Container>
        <div className="mx-auto max-w-2xl lg:mx-0">
          ...
          <p className="mt-4 font-display text-2xl tracking-tight text-blue-900">
            Poslechněte si příběhy zkušených sportovců a cestovatelů
            z destinací od Kanady po Kazachstán, od Labáku i z Iráku.
          </p>
        </div>
        <Tab.Group
          as="div"
